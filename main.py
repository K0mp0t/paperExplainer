...
inputs = {"messages": [("user", "Get first five references for paper titled Exploring Human-like Attention Supervision in Visual Question Answering. You can get the full text with tools")],
          "model": model, "tools": tools, "system_message": config['system_message']}
